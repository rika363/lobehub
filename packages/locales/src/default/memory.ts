export default {
  ...
  'rules.archivedAt': 'Archived on {{time}}',
  'rules.archivedGroup': 'Archived ({{count}})',
  'rules.backlog': '{{count}} rejected rounds have not been read yet',
  'rules.detail.revisions': 'Edits',
  'rules.detail.sources': 'Where it came from',
  'rules.detail.sourcesEmpty': 'The rejections behind this rule are no longer reachable.',
  'rules.empty.description':
    'Rules are distilled from the checks you reject \u2014 the reason you wrote, and the region you circled. Nothing here is written by hand.',
  ...
  'rules.meta.lastSeen': 'last {{time}}',
  'rules.meta.rejections': 'from {{count}} rejections',
  'rules.openAcceptance': 'Open the acceptance',
  'rules.restore': 'Put back to work',
  'rules.reviewerSaid': 'You said',
  'rules.revisedBySystem': 'Narrowed by the system',
  'rules.revisedByYou': 'Narrowed by you',
  'rules.section.how': 'For example',
  'rules.section.limits': 'When it does not apply',
  'rules.section.why': 'Why',
  'rules.subtitle': 'What you require of a delivery, written down from the rounds you sent back.',
