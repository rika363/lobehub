export default {
  ...
  'verifiers.archive': 'Archive',
  'verifiers.archivedAt': 'Archived on {{time}}',
  'verifiers.archivedGroup': 'Archived ({{count}})',
  'verifiers.backlog': '{{count}} rejected rounds have not been read yet',
  'verifiers.detail.revisions': 'Edits',
  'verifiers.detail.sources': 'Where it came from',
  'verifiers.detail.sourcesEmpty': 'The rejections behind this verifier are no longer reachable.',
  'verifiers.empty.description':
    'Verifiers are distilled from the checks you reject \u2014 the reason you wrote, and the region you circled. Nothing here is written by hand.',
  'verifiers.empty.title': 'No verifiers yet',
  'verifiers.exception.placeholder':
    'Say where it stops applying, e.g. "spacing inside a chart does not count".',
  'verifiers.exception.submit': 'Add exception',
  'verifiers.meta.lastSeen': 'last {{time}}',
  'verifiers.meta.rejections': 'from {{count}} rejections',
  'verifiers.openAcceptance': 'Open the acceptance',
  'verifiers.restore': 'Put back to work',
  'verifiers.reviewerSaid': 'You said',
  'verifiers.revisedBySystem': 'Narrowed by the system',
  'verifiers.revisedByYou': 'Narrowed by you',
  'verifiers.section.how': 'For example',
  'verifiers.section.limits': 'When it does not apply',
  'verifiers.section.why': 'Why',
  'verifiers.subtitle':
    'What you require of a delivery, written down from the rounds you sent back.',
  'verifiers.title': 'Delivery verifiers',
  'tab.preferences': 'Preferences',
  'tab.search': 'Search',
  'tab.verifiers': 'Verifiers',
