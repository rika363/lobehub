export default {
  ...
  'standards.backlog': '{{count}} rejected rounds have not been read yet',
  'standards.basis.mechanism': 'Mechanism',
  'standards.basis.taste': 'Taste',
  'standards.detail.empty': 'Pick a standard to see what it rests on.',
  'standards.detail.sources': 'Where it came from',
  'standards.detail.sourcesEmpty': 'The rejections behind this standard are no longer reachable.',
  'standards.empty.description':
    'Standards are distilled from the checks you reject — the reason you wrote, and the region you circled. Nothing here is written by hand.',
  'standards.empty.title': 'No standards yet',
  'standards.meta.lastSeen': 'last {{time}}',
  'standards.meta.rejections': 'from {{count}} rejections',
  'standards.meta.rounds': 'across {{count}} rounds',
  'standards.openAcceptance': 'Open the acceptance',
  'standards.reviewerSaid': 'You said',
  'standards.section.how': 'For example',
  'standards.section.limits': 'When it does not apply',
  'standards.section.why': 'Why',
  'standards.subtitle':
